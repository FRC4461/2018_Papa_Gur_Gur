...
public class GripperMotors extends Command {
	...
	private static final float CUBE_LENGTH_COUNTS = CUBE_LENGTH * 
			COUNTS_PER_REVOLUTION * GEAR_REDUCTION / WHEEL_CIRCUMFERENCE;
    ...
    protected void execute() {
    	if (motorState == GripperMotorState.intake) {
			...
			// TODO: Actually figure out what value will tell us the cube made it in
			// securely
